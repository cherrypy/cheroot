...
@pytest.mark.parametrize(
    ('adapter_type', 'encrypted_key', 'password_as_bytes'),
    (
        ('builtin', True, True),
        ('builtin', True, False),
        ('builtin', False, True),
        ('builtin', False, False),
        ('pyopenssl', True, True),
        ('pyopenssl', True, False),
        ('pyopenssl', False, True),
        ('pyopenssl', False, False),
    ),
    ids=(
        'builtin-encrypted-key-with-str-password',
        'builtin-encrypted-key-with-bytes-password',
        'builtin-non-encrypted-key-with-str-password',
        'builtin-non-encrypted-key-with-bytes-password',
        'pyopenssl-encrypted-key-with-str-password',
        'pyopenssl-encrypted-key-with-bytes-password',
        'pyopenssl-non-encrypted-key-with-str-password',
        'pyopenssl-non-encrypted-key-with-bytes-password',
    ),
)
# pylint: disable-next=too-many-positional-arguments
...
@pytest.mark.parametrize(
    ...
    ids=('false-password', 'integer-password', 'too-long-password'),
)
